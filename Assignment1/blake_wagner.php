<html lang="en">
	...
	<body>
		<link rel="stylesheet" href="assets/css/detail.css" />
			<?php
			echo "<title>ASE 230 - Blake Wagner</title>";
			?>
			<div class="container text-center mb-5">
				<?php
					echo "<h1>This is ASE 230 - Blake Wagner</h1>";
				?>
			</div>
    ...
    <div class="row">
      <div class="col-lg-5 col-md-6">
        ...
        <div class="mb-2 d-flex">
          <?php 
			echo '<h4 class="font-weight-normal">Your name</h4>';
		  ?>
          ...
          <ul class="list-unstyled">
            <li class="media">
              <?php 
				...
				echo '<label class="media-body">Server-side developer</label>';
			  ?>
            </li>
            <li class="media">
              <?php 
				echo '<span class="w-25 text-black font-weight-normal">Dream company: </span>";
				echo "<label class="media-body">Google</label>";
			  ?>
            </li>
            <li class="media">
				<?php
				echo "<span class="w-25 text-black font-weight-normal">Email: </span>';
				echo '<label class="media-body">wagnerb7@mymail.nku.edu</label>';
			  ?>
            </li>
          </ul>
        </div>
      ...
      <div class="col-lg-7 col-md-6 pl-xl-3">
		...
		<?php 
			echo "<p>Blake is a student at Northern Kentucky University. He grew up in Florence Kentucky and went to Dixie Heights High School. He decided to go into the cybersecurity field for his interest
          ...
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
              <?php 
				...
				echo '<span class="progress-bar-number">85%</span>';
			  ?>
            </div>
          </div>
        </div>
          ...
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
              <?php 
				...
				echo '<span class="progress-bar-number">70%</span>';
			  ?>
            </div>
          </div>
        </div>
        <div class="py-1">
          <div class="progress">
            <div class="progress-bar" role="progressbar" style="width:77%" aria-valuenow="77" aria-valuemin="0" aria-valuemax="100">
              <?php
				...
				echo '<span class="progress-bar-number">77%</span>';
			  ?>
            </div>
          </div>
        </div>
		  <?php
			...
			echo '<p>It is truly amazing the damage that we, as parents, can inflict on our children. So why do we do it? For the most part, we don’t do it intentionally or with malice. In the majority of cases, the cause is a 
