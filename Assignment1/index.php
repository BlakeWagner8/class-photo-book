...
<html lang="en">
	<head>
		...
		<?php 
			echo "<title>ASE 230 - class of Spring/Fall/Summer 20XX</title>";
		?>
	</head>
	<body>
		<div class="container text-center">
			<?php
				echo "<h1>This is ASE 230 - class of Spring/Fall/Summer 20XX</h1>";
			?>
		</div>
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-sm-8 col-lg-6">
					...
					<div class="section_heading text-center wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
						<?php 
							echo "<h3>Our Creative <span> Team</span></h3>";
							echo "<p>Appland is completely creative, lightweight, clean &amp; super responsive app landing page.</p>";
						?>
						<div class="line"></div>
					</div>
				</div>
			...
			<div class="row">
				...
				<?php 
					echo "<h6>Blake Wagner</h6>";
					echo '<p class="designation">Cybersecurity Major at NKU</p>'
				?>
				</div>
				</div>
				</div>
