    ...
    <div class="row">
		...
		<!--prints list of information for student-->
          <ul class="list-unstyled">
			...
			<li class="media">
				...
				<label class="media-body"><?php echo dateDiff($students[$_GET['index']]['birthday'], '%Y'); ?></label>
            </li>
			<li class="media">
				<span class="w-25 text-black font-weight-normal"><?php echo 'Time since born: ' ?></span>
				<label class="media-body"><?php echo $students[$_GET['index']]['name'] . ' was born ' . dateDiff($students[$_GET['index']]['birthday'], '%Y' . ' years, ' . '%m' . ' months and ' . '%d' . ' days ago.'); ?></label>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-lg-7 col-md-6 pl-xl-3">
        ...
        <div class="my-2 bg-light p-2">
			<h5 class="font-weight-normal"><?php echo 'Favorite Quote'?></h5>
			<p><?php echo $students[$_GET['index']]['quote']?></p>
        </div>
